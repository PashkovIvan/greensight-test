	...
	<main class="form-signin w-100 m-auto">
		<form id="regForm" action="/register.php">
			...
			<div class="form-floating">
				<input type="text" required class="form-control" id="firstName" placeholder="Иван" name="<?=FIRST_NAME_INPUT_NAME?>">
				<label for="firstName">Имя</label>
			</div>
			<div class="form-floating">
				<input type="text" required class="form-control" id="lastName" placeholder="Иванов" name="<?=LAST_NAME_INPUT_NAME?>">
				<label for="lastName">Фамилия</label>
			</div>
			<div class="form-floating">
				<input type="email" required class="form-control" id="email" placeholder="ivanov.i@mail.ru" name="<?=EMAIL_INPUT_NAME?>">
				<label for="email">Email</label>
			</div>
			<div class="form-floating">
				<input type="password" required class="form-control" id="password" placeholder="Пароль" name="<?=PASSWORD_INPUT_NAME?>">
				<label for="password">Пароль</label>
			</div>
			<div class="form-floating">
				<input type="password" required class="form-control" id="passwordRepeat" placeholder="Повторите пароль" name="<?=PASSWORD_REPEAT_INPUT_NAME?>">
